...
export function ExpertsSection() {
  ...
  // Animation states
  const [showSarahMessage, setShowSarahMessage] = useState(false)
  const [showMichaelMessage, setShowMichaelMessage] = useState(false)
  ...
  useEffect(() => {
    ...
    setShowFire(false)
    setShowChat(true)
    setShowSarahMessage(false)
    setShowMichaelMessage(false)
    
    // Start chat animation loop
    const runChatAnimation = () => {
      // First show Sarah's message
      setTimeout(() => {
        setShowSarahMessage(true)
        
        // Then after a delay, show Michael's message
        setTimeout(() => {
          setShowSarahMessage(false)  // Hide Sarah's message
          setShowMichaelMessage(true) // Show Michael's message
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              setTimeout(() => {
                ...
                }, 3000) // Time showing dashboard
              }, 2000) // Time showing chat with reactions
            }, 600) // Delay between reactions
          }, messageToType.length * 30 + 500) // Wait for typing to complete
        }, 2000) // Delay before showing Michael's message (2 seconds to read Sarah's message)
      }, 300) // Initial delay before showing Sarah's message
    }
        ...
        <div ref={tableRef} className="h-full w-full">
          ...
          <div className="flex flex-wrap gap-2">
            <div className="px-3 py-1 bg-[#2a2a2a] rounded-full text-sm text-gray-300 flex items-center">
              ...
              <span>Monitoring 28 competitors</span>
            </div>
            <div className="px-3 py-1 bg-[#2a2a2a] rounded-full text-sm text-gray-300 flex items-center">
        ...
        {showChat && (
          ...
          >
            ...
            <div className="p-4 h-[calc(100%-50px)] overflow-hidden">
              ...
              {/* Second message - Michael (with typing animation) */}
              {showMichaelMessage && (
