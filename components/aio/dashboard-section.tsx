  ...
  return (
    <section className="py-24 bg-[#111827] relative overflow-hidden">
      ...
      <div className="absolute -bottom-24 left-0 right-0">
        <svg className="w-full h-24" viewBox="0 0 1440 320" preserveAspectRatio="none">
          <path fill="#ffffff" d="M0,0L48,16C96,32,192,64,288,80C384,96,480,96,576,80C672,64,768,32,864,24C960,16,1056,32,1152,48C1248,64,1344,80,1392,88L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg>
      </div>
    </section>
  )
