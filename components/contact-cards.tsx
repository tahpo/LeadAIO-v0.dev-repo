  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
      <div className={styles.contactCard}>
        ...
        <a href="mailto:hello@leadaio.com" className="text-blue-600 hover:text-blue-700 text-sm font-universal mt-auto">
          hello@leadaio.com
        </a>
      </div>
      ...
      <div className={styles.contactCard}>
        ...
        <button className="text-green-600 hover:text-green-700 text-sm font-universal mt-auto">
      ...
      <div className={styles.contactCard}>
        ...
        <a href="tel:+1234567890" className="text-purple-600 hover:text-purple-700 text-sm font-universal mt-auto">
          +1 (234) 567-890
        </a>
      </div>
    </div>
