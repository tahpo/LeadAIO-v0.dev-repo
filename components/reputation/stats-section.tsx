...
export function ReputationStats() {
  ...
  return (
    <section ref={containerRef} className="py-24 md:py-32 bg-white relative overflow-hidden mt-16 md:mt-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
          {summary.map((item) => {
            ...
            return (
              <Card key={item.name} className="p-6 min-h-[280px] md:min-h-[320px]">
                <div>
