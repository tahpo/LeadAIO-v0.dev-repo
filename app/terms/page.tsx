      ...
      <main className="flex-grow container max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-garnett mb-4">1. Agreement to Terms</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-garnett mb-4">2. Use of Services</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-garnett mb-4">3. Subscription and Payments</h2>
            <p className="text-gray-600 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-garnett mb-4">4. Intellectual Property</h2>
            <p className="text-gray-600 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-garnett mb-4">5. Limitation of Liability</h2>
            <p className="text-gray-600 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-garnett mb-4">6. Termination</h2>
            <p className="text-gray-600 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-garnett mb-4">7. Changes to Terms</h2>
